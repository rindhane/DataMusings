...
- To find all details related to the working of the code, checkout the jupyter-notebook [here](https://github.com/rindhane/DataMusings/blob/master/Img_Classifier/dog_app.ipynb).
...
This project is licensed under the MIT License - see the [LICENSE.md](https://github.com/rindhane/DataMusings/blob/master/Img_Classifier/LICENSE.md) file for details
